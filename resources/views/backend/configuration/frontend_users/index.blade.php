            ...
            <div class="col-md-9">
                ...
                <div class="row align-items-center d-flex justify-content-between">
                    ...
                    <div class="col-6 mb-4 mt-2">
                        <form action="{{ route('backend.configuration.frontend_users') }}" class="form">
                    ...
                    <div class="col-12 table-responsive">
                        @if($users->count() >= 1)
                            <table class="table">
                                ...
                                <th>
                                    Usuario
                                    <a href="{{ route('backend.configuration.frontend_users').'?email_search='.$email_search.'&order_by_usuario='.(null==$order_by_usuario ? 'asc':$order_by_usuario) }}" class="arrow-order">
                                        <i class="material-icons top-arrow {{ ($order_by_usuario && $order_by_usuario == 'asc') ? 'active':'' }}">
                                            arrow_drop_up
                                        </i>
                                        <i class="material-icons bottom-arrow {{ ($order_by_usuario && $order_by_usuario == 'desc') ? 'active':'' }}">
                                            arrow_drop_down
                                        </i>
                                    </a>
                                </th>
                                <th>
                                    Email
                                    <a href="{{ route('backend.configuration.frontend_users').'?email_search='.$email_search.'&order_by_email='.(null==$order_by_email ? 'asc':$order_by_email) }}" class="arrow-order">
                                ...
                                <th>
                                    Nombres
                                    <a href="{{ route('backend.configuration.frontend_users').'?email_search='.$email_search.'&order_by_name='.(null==$order_by_name ? 'asc':$order_by_name) }}" class="arrow-order">
                                ...
                                <th>
                                    Apellidos
                                    <a href="{{ route('backend.configuration.frontend_users').'?email_search='.$email_search.'&order_by_lastname='.(null==$order_by_lastname ? 'asc':$order_by_lastname) }}" class="arrow-order">
