...
class CertificadoPDF extends TCPDF
{
    ...
    public function Footer()
    {
        ...
        $this->write2DBarcode(url('validador/documento?id=' . $this->id . '&key=' . $this->key), 'QRCODE,H', '', '', 30, '');
        ...
        $this->MultiCell(4 * CELL_WIDTH + 3 * GRID_WIDTH, '', url('validador'), 0, 'L', false, 1, PAGE_MARGIN);
        ...
        $this->Image(public_path('img/certificados/color_gobierno-chile.png'), PAGE_MARGIN, $y + 70, CELL_WIDTH, 5, '', '', 'T', true);
